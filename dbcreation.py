...
name_product VARCHAR(100) NOT NULL, id_category SMALLINT NOT NULL,\
nutri_score CHAR(1) NOT NULL, description_product VARCHAR(200) NOT NULL,\
link_url VARCHAR(200) NOT NULL, PRIMARY KEY (id));\
\
...
name VARCHAR(100) NOT NULL, city VARCHAR(50) NOT NULL, PRIMARY KEY (id));\
\
...
id_store SMALLINT UNSIGNED NOT NULL, PRIMARY KEY (id_product, id_store));")
